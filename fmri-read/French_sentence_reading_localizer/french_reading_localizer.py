#! /usr/bin/env python
# Time-stamp: <2015-04-23 15:31 christophe@pallier.org>
...
* 21th January: JB added a wait (script is waiting for 2 'T' before launching experiment)
"""

SOA = 300   # stimulus onset asynchrony (=time of display of character chunks)
BLOCDURATION = SOA * 34
NBLOCKS = 24
INITIALWAIT = 3000
BETWEEN_BLOCS = 8000
...
fixcross = stimuli.FixCross(size=(40, 40), line_width=3, colour=(0, 255, 0))
fixcross.preload()

fixcross2 = stimuli.FixCross(size=(40, 40), line_width=3, colour=(128, 128, 128))
fixcross2.preload()
...
for line in sequences:
    ...
    stim = []
    for w in line[1:]:
        stim = stimuli.TextLine(w, text_font='Inconsolata.ttf', text_size=60)
