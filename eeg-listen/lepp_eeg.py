...
# Note: this sample script requires the open-source library “pyserial” to be installed.
...
AUDIO = f'wav/ch{dict_i_chapt[run]}.wav'##'wav/ch1-3.wav'
...
p1 = eeg_triggers.send_start(initialized)
initialized = True # to not have to recreate the parport
exp.clock.wait(50)
eeg_triggers.send_stop(p1)
...
p1 = eeg_triggers.send_start(initialized,p1)
exp.clock.wait(50)
eeg_triggers.send_stop(p1)
